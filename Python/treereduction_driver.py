...
from treereduction_program import ResultType, ProblemType
import treereduction_program
...
def run(numbers: list, expected_solution: list):
    ...
    rootProblem.problem_id = treereduction_program.root_problem_id

    payload = {
        "problem": rootProblem,
        "problem_type": ProblemType,
        "result_type": ResultType,
        "null_result": treereduction_program.NullResult,
        "stop_result": treereduction_program.StopResult
    }
