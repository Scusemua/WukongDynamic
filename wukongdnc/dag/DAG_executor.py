...
#rhc: lambda inc:     
                ...
                logger.debug("DAG_executor: lambda does NOT try to get new incremental DAG for lambda.")
            #logging.shutdown()
            #os._exit(0)
...
#rhc: lambda inc:
                    logger.debug("DAG_executor_work_loop: group has TBC fanins/fanouts and we did not"
