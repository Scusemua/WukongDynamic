...
# then above we will (eventually) get the collapse task from the cluster_queue
#if len(cluster_queue) > 0:
# ...
#   DAG_executor_state.state = v.get()
# ...
...
#rhc: cluster: using DAG_exec_state instad of "returned_state"
