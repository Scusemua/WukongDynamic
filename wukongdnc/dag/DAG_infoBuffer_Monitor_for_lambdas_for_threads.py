"""
Not using this. Using wukongdnc/dag/DAG_infoBuffer_Monitor_for_threads.py.
We essentially copied this there and used an if-statement that checks
whether we are using workers or lambdas.
"""
...
if run_all_tasks_locally and not using_workers and compute_pagerank and use_incremental_DAG_generation and using_threads_not_processes:
