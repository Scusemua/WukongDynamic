...
#rhc incremental groups
                                    if not use_page_rank_group_partitions:
                                        if len(leaf_tasks_of_partitions_incremental) > 0:
                                            ...
                                            # get started but only if the leaf task is not the second
                                            # partition/group.If not, if we are using workers, deposit these leaf 
                                            ...
                                            # at the beginning of DAG excution - this includes the first leaf
