...
CLEAR_BFS_MAIN_MAP_ON_THE_FLY = False
CLEAR_BFS_GRAPH_NODES_ON_THE_FLY = False
CLEAR_BFS_PARTITIONS_GROUPS_NAMES = False
CLEAR_BFS_SENDERS_AND_RECEIVERS = False
THRESHOLD_FOR_CLEARING_ON_THE_FLY = 1
#
...
def test49():
    ...
    USE_PAGERANK_GROUPS_PARTITIONS = COMPUTE_PAGERANK and True
    USE_STRUCT_OF_ARRAYS_FOR_PAGERANK = COMPUTE_PAGERANK and False
    USE_MUTLITHREADED_BFS = COMPUTE_PAGERANK and True
    INPUT_ALL_GROUPS_PARTITIONS_AT_START = COMPUTE_PAGERANK and False
