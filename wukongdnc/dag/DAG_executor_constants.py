...
# generate dsk map, ready input leaf-input files, and ready input partition/group files
# for the ADG generated by non-inremental DAG generation. In this case, we are generating
# a DAG that will be executed on AzSR by letting bfs() build a DAG and then denerating
...
USE_PAGERANK_GROUPS_INSTEAD_OF_PARTITIONS = COMPUTE_PAGERANK and True
...
DEALLOCATE_PARTITION_GROUP_DAG_STRUCTURES_FOR_WORKERS = COMPUTE_PAGERANK and USING_WORKERS and USE_INCREMENTAL_DAG_GENERATION and False

DEALLOCATE_DAG_INFO_STRUCTURES_FOR_LAMBDAS = COMPUTE_PAGERANK and not USING_WORKERS and USE_INCREMENTAL_DAG_GENERATION and True
...
def non_pagerank_non_store_objects_in_lambda_base():
    ...
    global USE_PAGERANK_GROUPS_INSTEAD_OF_PARTITIONS
...
def test35():
    ...
    PAGERANK_GRAPH_FILE_NAME = "graph_24N_3CC_fanin_restoredealloc"
    ...
    TASKS_USE_RESULT_DICTIONARY_PARAMETER = COMPUTE_PAGERANK and True
    USE_SHARED_PARTITIONS_GROUPS = COMPUTE_PAGERANK and False
    USE_PAGERANK_GROUPS_INSTEAD_OF_PARTITIONS = COMPUTE_PAGERANK and False
    USE_STRUCT_OF_ARRAYS_FOR_PAGERANK = COMPUTE_PAGERANK and False
    USE_MUTLITHREADED_NONINCREMENTAL_BFS = COMPUTE_PAGERANK and False
    INPUT_ALL_GROUPS_PARTITIONS_AT_START = COMPUTE_PAGERANK and False
    ...
    DEALLOCATE_PARTITION_GROUP_DAG_STRUCTURES_FOR_WORKERS = \
        COMPUTE_PAGERANK and USING_WORKERS and USE_INCREMENTAL_DAG_GENERATION and False
