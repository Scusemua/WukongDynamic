...
#brc: use of DAG_info:
    ...
    # and we are deallocating parts of the DAG_info before we send the DAG_info
    # to a lambda then we need to make a deep copy of the DAG_info after it is generated.
    # This is because it is possible that the deallocations for/to DAG_info will be
    # done concurrently with the simulated lambda referencing/executing the DAG_info. Thus,
