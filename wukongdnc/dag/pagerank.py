...
class Node:
    ...
    def update_pagerank(self, d, n):
        ...
        print ("pagerank_sum: " + str(pagerank_sum))
        random_jumping = d / n
        print ("d:" + str(d) + " n: " + str(n) + " random_jumping: " + str(random_jumping))
        self.pagerank = random_jumping + (1-d) * pagerank_sum
        print ("self.pagerank: " + str(self.pagerank))
        print()
        print()
...
if __name__ == '__main__':
    ...
    graph = init_graph('./pagerank1.txt')
